<template>
    <div>
        ...
        <el-row v-if="active == 0">
            <el-form :inline="true" :model="employeeData" :rules="rules" ref="formOne" label-width="200px"
                class="demo-ruleForm">
        ...
        <el-row v-if="active == 1">
            <el-form :inline="true" :model="employeeData" :rules="rules" ref="formTwo" label-width="200px"
                class="demo-ruleForm">
        ...
        <el-row v-if="active == 2">
            <el-form :inline="true" :model="employeeData" :rules="rules" ref="formThree" label-width="200px"
                class="demo-ruleForm">
                ...
                <el-button style="margin-top: 40px;" @click="back">Back</el-button>
                <el-button disabled style="margin-top: 12px" @click="next()">Next step</el-button>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            this.storedEmployeeData.forEach(item => {

<template>
    <div>
        ...
        <div class="name">
            <el-dialog title="Enter Employee Information" :visible.sync="dialogFormVisible">
                {{ tableData }}
                <el-form inline=true :model="employeeData" ref="employeeData" :rules="rules" label-width="200px"
                    ...
                    <el-form-item prop="dob" label="DOB">
                        ...
                        <el-date-picker v-model="employeeData.dob" value-format="dd/MM/yyyy" placeholder="yyyy-mm-dd">
                        </el-date-picker>
                    </el-form-item>
                ...
                <span class="demonstration">Date of Joining </span> -->
                        <el-date-picker v-model="employeeData.dateOfJoining" value-format="dd/MM/yyyy"
                    ...
                    <el-form-item inline=true>
                        <el-button style="float:right" type="primary" @click="cancel">cancel</el-button>
